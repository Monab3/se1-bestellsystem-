...
public class ArticleTest {
	...
	public void test002_EmptyArgumentConstructor() {
		 ...
		 */
		Article test = new Article ("", "", 0, 0);
		assertEquals(test.getId(),"");
		assertEquals(test.getDescription(),"");
		assertEquals(test.getUnitPrice(),0);
		assertEquals(test.getUnitsInStore(),0);
	...
	public void test003_NullArgumentConstructor() {
		 ...
		 */
		Article test = new Article (null, null, -1, -1 );
	...
	public void test010_SetDescription() {
		...
		aToaster.setDescribtion( description );
		assertEquals(aToaster.getDescription(),"Super Toaster Model XRC-2484698");
		aToaster.setDescribtion( "" );
		assertEquals(aToaster.getDescription(),"");
		aToaster.setDescribtion(null);
		assertEquals(aToaster.getDescription(),"");
	...
	public void test011_SetUnitPrice() {
		...
		assertEquals(aToaster.getUnitPrice(),100);
	...
	public void test012_SetUnitsInStore() {
		...
		assertEquals(aToaster.getUnitsInStore(),100);
